...
{ 
  echo "<script>alert('Maaf, Email anda tidak terdaftar!');location.replace('../lupapassword.php')</script>";
}else {
...
if(empty($attachment)){ // Jika tanpa attachment
    ...
    if($send){ // Jika Email berhasil dikirim
        ...
        echo "<script>alert('Reset Password Berhasil Di Kirim Ke Email!');location.replace('../masuk.php')</script>";

    }else{ // Jika Email gagal dikirim
        echo "<script>alert('Email Gagal, Terkirim!');location.replace('../masuk.php')</script>"; }
