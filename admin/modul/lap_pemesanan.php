...
<p align="center"> <b>DATA LAPORAN PEMESANAN :</b> <b style="color:blue"><?php echo $tanggalawal1 ?></b> - <b style="color:blue"><?php echo $tanggalakhir1 ?></b> </p>
        ...
        <thead style="text-align: center; background-color:#C1C1C1">
          ...
          <td style="text-align: center; background-color:#f5f5f5">Nama Penerima</td>
          <td style="text-align: center; background-color:#f5f5f5">Nohp Penerima</td>
          <td style="text-align: center; background-color:#f5f5f5">Kurir</td>
          <td style="text-align: center; background-color:#f5f5f5">Ongkir</td>
      ...
      if (mysqli_num_rows($result) > 0)
      {
        ...
        { 
          ...
          $tanggal = date('d-m-Y', strtotime($data['tgl_checkout']));

          echo "<tr>
                  <td style='text-align: center'>".$no."</td>
                  <td style='text-align: center'>".$data['order_id']."</td>
                  <td style='text-align: left'>$tanggal</td>
                  <td style='text-align: center'>".$data['nama_penerima']."</td>
                  <td style='text-align: center'>".$data['no_hp']."</td>
                  <td style='text-align: center'>".$data['kurir']."</td>
                  <td style='text-align: center'>".$data['ongkir']."</td>
                  <td style='text-align: left'>Rp, $ttb</td>
                </tr>";
                $no++;
        }
      }
  ...
  <br>
         ...
         ?>
           ...
           <p style="text-align: center; background: #F5F5F5">Total Data Pemesanan: <?= $total; ?></p>
