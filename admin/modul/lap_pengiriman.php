...
?>
  ...
  <br>
<p align="center"> <b>DATA LAPORAN PENGIRIMAN :</b> <b style="color:blue"><?php echo $tanggalawal1 ?></b> - <b style="color:blue"><?php echo $tanggalakhir1 ?></b> </p>
        ...
        <thead style="text-align: center; background-color:#C1C1C1">
          ...
          <td style="text-align: center; background-color:#f5f5f5">No Resi</td>
          ...
          <td style="text-align: center; background-color:#f5f5f5">Nohp Pengirim</td>
          <td style="text-align: center; background-color:#f5f5f5">Keterangan</td>
          <td style="text-align: center; background-color:#f5f5f5">Tanggal Kirim</td>
        </tr>
      ...
      $sql = "SELECT * FROM tb_pengiriman WHERE tanggal_kirim between '$tanggalawal' AND '$tanggalakhir'  ORDER BY order_id ASC";
      ...
      if (mysqli_num_rows($result) > 0)
      {
        ...
        { 
          $tanggal = date('d-m-Y', strtotime($data['tanggal_kirim']));

          echo "<tr>
                  <td style='text-align: center'>".$no."</td>
                  <td style='text-align: center'>".$data['no_resi']."</td>
                  <td style='text-align: center'>".$data['order_id']."</td>
                  <td style='text-align: center'>".$data['nama_pengirim']."</td>
                  <td style='text-align: center'>".$data['nohp_pengirim']."</td>
  ...
  <br>
         ...
         ?>
           ...
           <p style="text-align: center; background: #F5F5F5">Total Pemesanan Telah Dikirim: <?= $total; ?></p>
