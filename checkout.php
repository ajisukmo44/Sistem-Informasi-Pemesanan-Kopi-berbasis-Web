							...
							<div class="col-lg-5">
								...
								<div class="row">
									<div class="col-lg-12">
										...
										<h5 class="text-center">INFORMASI PEMBELI / PENERIMA BARANG</h5>
										<hr>

										<div class="form-group">
											<label>Nama</label>
											<input type="text" class="input" name="nama" value="<?= $nm ?>" required="required">
										</div>

										<div class="form-group">
											<label>Nomor HP</label>
											<input type="number" class="input" name="no_hp" value="<?= $hp ?>" required="required">
										</div>

										<div class="form-group">
											<label>Alamat Lengkap RT/RW</label>
											<input row="col-2" type="text" class="input" name="alamat" value="<?= $alt ?>" required="required">
										</div>
										<?php 
...
$berat = 0;				$total = 0;
		...
		<tfoot>
			<tr>
													...
													<th>TOTAL BERAT</th>
													<th class="text-center"><?php echo $berat_total; ?> Gram</th>
												</tr>
												<tr>
													<th class="empty" colspan="2"></th>
													<th>ONGKIR</th>
