...
curl_setopt_array($curl_jne, array(
	...
	CURLOPT_POSTFIELDS => "origin=476&destination=".$id_kabupaten."&weight=".$berat."&courier=jne",
...
curl_setopt_array($curl_tiki, array(
	...
	CURLOPT_HTTP_VERSION => CURL_HTTP_VERSION_1_1,
	CURLOPT_CUSTOMREQUEST => "POST",
	CURLOPT_POSTFIELDS => "origin=476&destination=".$id_kabupaten."&weight=".$berat."&courier=tiki",
	CURLOPT_HTTPHEADER => array(
		"content-type: application/x-www-form-urlencoded",
		"key: 8f22875183c8c65879ef1ed0615d3371"
	),
