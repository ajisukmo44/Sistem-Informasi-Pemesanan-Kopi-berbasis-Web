	...
	<div class="container">
		...
		<div class="row">
			...
			<div id="main" class="col-md-12">
				...
				<?php
				$id = $_GET['id'];
				$kategori = mysqli_query($koneksi,"select * from tb_kategori where kategori_id='$id'");
				...
				<div id="store">
					...
					<div class="row">
						...
						if(isset($_GET['urutan']) && $_GET['urutan'] == "harga"){
							$data = mysqli_query($koneksi,"select * from tb_produk a,tb_kategori b where a.kategori_id='$kategori' and a.kategori_id=b.kategori_id order by harga asc LIMIT $mulai, $halaman");
						}else{
							$data = mysqli_query($koneksi,"select * from tb_produk a,tb_kategori b where a.kategori_id='$kategori' and a.kategori_id=b.kategori_id order by produk_id desc LIMIT $mulai, $halaman");
						}          
						$no =$mulai+1;
